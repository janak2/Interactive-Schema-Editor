...
def update():
    """
    gs update gs://bucket/key (same opts as cp)
    TODO: incorporate changes from
    https://github.com/chanzuckerberg/gs/compare/akislyuk-set-object-storage-class-in-multipart-encoding
    and check that non-utf8 objects work as expected
    """
